...
- **GroMo**: Played a pivotal role in creating and scaling GroMo platform, Designed and implemented REST APIs, authentication methods, and API security for a platform used by over 1.5 million insurance agents. Recognized as Employee of the Year.
